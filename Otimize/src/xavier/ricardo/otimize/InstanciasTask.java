...
public class InstanciasTask extends AsyncTask<String, Void, RespostaListagem> {
	
	private InstanciaActivity contexto;
	private String problema;
	private ProgressDialog progress;
	
	public InstanciasTask(InstanciaActivity contexto, String problema) {
	...
	protected RespostaListagem doInBackground(String... params) {
		...
		try {
			...
			String url = "http://ricardoxavier.no-ip.org/OtimizeService/rest/instancias"
					+ "?problema=" + problema;
			Log.i("OTIMIZE", url);
