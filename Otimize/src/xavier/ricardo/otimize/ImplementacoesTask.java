...
public class ImplementacoesTask extends AsyncTask<String, Void, RespostaListagem> {
	
	private ImplementacoesActivity contexto;
	private String problema;
	private ProgressDialog progress;
	
	public ImplementacoesTask(ImplementacoesActivity contexto, String problema) {
	...
	protected RespostaListagem doInBackground(String... params) {
		...
		try {
			...
			String url = "http://ricardoxavier.no-ip.org/OtimizeService/rest/implementacoes"
					+ "?problema=" + problema;
			Log.i("OTIMIZE", url);
