...
public class Executor {
	...
	public static RespostaOtimizacao executa(String problema, String instancia, String implementacao) throws IOException {
		
		RespostaOtimizacao resposta = new RespostaOtimizacao();
		
		Runtime rt = Runtime.getRuntime();
		String[] cmd = { "./" + implementacao, instancia + ".txt" };
